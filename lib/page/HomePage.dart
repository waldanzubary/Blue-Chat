...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  // Add iconTheme here to change the leading app bar icon color
    ...
    if (data != null && _auth.currentUser!.email != data['email']) {
      return Container(
        ...
        child: ListTile(
          ...
          title: Text(
              data['username'] != null ? (data['username'].length <= 15 ? data['username'] : '${data['username'].substring(0, 15)}...') : 'Unknown',
